 ...
 * Puncuation.java
 * 
 * Working on: Using String methods and Scanner
 * Program prints out words with puncuation.
*/
 ...
 * class Header
 * 	main header
 * 		create instance and call searchIt
 * 	
 * 	searchIt
 * 		print 3 lines
 * 		call getPuncuationWords
 * 
 * 	getPuncuationWords
 * 		define strings
 * 		init. Scanner
 * 		use while loop to sort through each word
 * 			call checkForPuncuation(pass word)
 * 			call printWords(pass word)
 * 		
 * 	checkForPuncuation
...
public class Punctuation
{
	...
	public void getPunctuationWords()
	{
		...
		String words = new String("Blood, Sweat, and Tears by Winston Churchill " +
"May 13, 1940" +
"Mr. Speaker:" +
"On Friday evening last I received His Majesty’s commission to form a new " +
"Administration. It was the evident wish and will of Parliament and the nation that this should be conceived on the broadest possible basis and that it shouldinclude all parties, both those who supported the late Government and also the parties of the Opposition." +
...
"But I take up my task with buoyancy and hope. I feel sure that our cause will not be suffered to fail among men. At this time I feel entitled to claim the aid of all, and I say, \"Come then, let us go forward together with our united strength.\"");
	...
	public String checkForPunctuation(String words)
	{
		...
		if(words.charAt(0) == '.'||words.charAt(0) == '.'||words.charAt(0) == ','||words.charAt(0) == ';'||words.charAt(0) == ':'||words.charAt(0) == '\''||words.charAt(0) == '"'||words.charAt(0) == '!'||words.charAt(0) == '?'||words.charAt(0) == '(')
			return words +" ";
		else if(words.charAt(len-1) == '.'||words.charAt(len-1) == '.'||words.charAt(len-1) == ','||words.charAt(len-1) == ';'||words.charAt(len-1) == ':'||words.charAt(len-1) == '\''||words.charAt(len-1) == '"'||words.charAt(len-1) == '!'||words.charAt(len-1) == '?'||words.charAt(len-1) == '(')
			return words + " ";
		else
			return "";
	...
	public void printWords(String toPrint)
	{
